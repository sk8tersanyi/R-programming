...
* ezekből kiderül, hogy megint arról van szó, hogy szeretnénk kevesebbet gépelni, például:
<blockquote>
  <p> list(rep(1,4), rep(2,3), rep(3,2), rep(4,1)) #ehelyett a következőt érdemes írni </p>
